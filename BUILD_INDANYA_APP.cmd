...
"%BUILD_PYTHON%" -m PyInstaller --noconfirm --clean --distpath "%CD%\dist-growth-v53" --workpath "%CD%\build-growth-v53" IndanyaStudio.spec
if errorlevel 1 pause & exit /b 1
echo.
echo 完成: %CD%\dist-growth-v53\IndanyaStudio\IndanyaStudio.exe
pause
