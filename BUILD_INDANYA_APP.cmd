...
"%BUILD_PYTHON%" -m PyInstaller --noconfirm --clean --distpath "%CD%\dist-growth-v40" --workpath "%CD%\build-growth-v40" IndanyaStudio.spec
if errorlevel 1 pause & exit /b 1
echo.
echo 完成: %CD%\dist-growth-v40\IndanyaStudio\IndanyaStudio.exe
pause
