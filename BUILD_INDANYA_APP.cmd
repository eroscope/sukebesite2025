...
"%BUILD_PYTHON%" -m PyInstaller --noconfirm --clean --distpath "%CD%\dist-growth-v44" --workpath "%CD%\build-growth-v44" IndanyaStudio.spec
if errorlevel 1 pause & exit /b 1
echo.
echo 完成: %CD%\dist-growth-v44\IndanyaStudio\IndanyaStudio.exe
pause
