...
if exist "%CD%\dist-growth-v57\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v57\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b %errorlevel%
)
if exist "%CD%\dist-growth-v56\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v56\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b %errorlevel%
)
...
if exist "%CD%\dist-growth-v44\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v44\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b 0
)
...
if exist "%CD%\dist-growth-v38\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v38\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b 0
)

if exist "%CD%\dist-growth-v37\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v37\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b 0
)

if exist "%CD%\dist-growth-v36\IndanyaStudio\IndanyaStudio.exe" (
  powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%CD%\tools\indanya_watchdog.ps1" -Executable "%CD%\dist-growth-v36\IndanyaStudio\IndanyaStudio.exe" -SiteRoot "%CD%" -Show
  exit /b 0
)
